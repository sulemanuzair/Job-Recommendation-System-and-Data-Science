...
user_history = 0
filesInputNames = [ 
                    dataset_path + '/splitjobs/splitjobs/jobs1_part.tsv',
                    dataset_path + '/splitjobs/splitjobs/jobs2_part.tsv',
                    dataset_path + '/splitjobs/splitjobs/jobs3_part.tsv',
                    dataset_path + '/splitjobs/splitjobs/jobs4_part.tsv',
                    dataset_path + '/splitjobs/splitjobs/jobs5_part.tsv',
                    dataset_path + '/splitjobs/splitjobs/jobs6_part.tsv',
                    dataset_path + '/splitjobs/splitjobs/jobs7_part.tsv',
                    dataset_path + '/users/users_part.tsv',
                    dataset_path + '/user_history/user_history_part.tsv',
                    dataset_path + '/apps/apps_part.tsv'
        ]
...
for i in range(len(filesInputNames)):
    ...
    if(i >= 0 and i <= 6):
        if(i == 1):         
            ...
            data =pd.read_csv(dataset_path + '/splitjobs/splitjobs/jobs1_part.tsv'  , sep='\t')
